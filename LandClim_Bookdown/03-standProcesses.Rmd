...
+=======================+======================+=======================+
| SaplingInitialBiomass | numeric              | 0,01 tonnes (10kg)    |
|                       |                      | the initial tree      |
|                       |                      | biomass (Bi (t=0)     |
|                       |                      | assumed to be the     |
...
|                       |                      | than 10 years old     |
+-----------------------+----------------------+-----------------------+
| rela                  |                      | Ratio of realized     |
| tiveGrowthPerformance |                      | growth incremetn      |
|                       |                      | during the last 10    |
|                       |                      | years to max          |
|                       |                      | potential growth      |
|                       |                      | increment under       |
...
|                       |                      | GrowthPerformance[i]; |
+-----------------------+----------------------+-----------------------+
| \_opt                 |                      | maximun potential     |
| imumGrowthPerformance |                      | growth icrement under |
|                       |                      | optimal environmental |
|                       |                      | conditions            |
|                       |                      |                       |
|                       |                      | \_initialSapl         |
